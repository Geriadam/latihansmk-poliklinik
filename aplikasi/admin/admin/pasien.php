...
<tbody>
    <?php
    $query=mysql_query("SELECT A.id_pasien,A.nama,A.alamat,A.tanggal_lahir,A.telp,A.jenis_kelamin,A.poliklinik,B.nama_poli FROM pasien A,poliklinik B where A.poliklinik=B.id_poli ORDER BY A.tanggal ASC");
    $no=1;
