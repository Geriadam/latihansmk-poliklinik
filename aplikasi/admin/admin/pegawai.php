  ...
  ?>  
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Data Pegawai</h3>
                </div>
            </div>
...
<tbody>
  ...
  ?>
    <tr align='left'>
        ...
        <td width="10%">
<a title="Detail Data" ata-toggle="modal" id="<?php echo $a[0]; ?>" class="Open-Detil btn btn-success" href="#"><span class="glyphicon glyphicon-eye-open"></span></a>
<a class="Open-Edit btn btn-primary" href='#' title='Edit Data' data-id="<?php echo $a[0]; ?>" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span></a>
<a href="#" onclick="confirm_modal('pegawai-hapus.php?hapus=1&pegawai=<?php echo $a[0]; ?>');"><button class="btn-danger btn"><span class="glyphicon glyphicon-trash"></span></button></a>
        </td>
    </tr>
    <?php
    $no++;
