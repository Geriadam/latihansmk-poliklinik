  ...
  ?>  
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Data Poliklinik</h3> 
                </div>
            </div>
...
if(!empty($_GET['pesan']) && $_GET['pesan']=='sukses'){
    ...
    echo '<strong>Berhasil!</strong> Data Berhasil Di Simpan</div>';
}?>
<?php
...
<thead>
    <tr align='left'>
        <th width="5%">No.</th>
        <th width="10%">Nama Poliklinik</th>
        <th width="10%">Pilihan</th>
    </tr>
</thead>
<tbody>
    <?php
    $query=mysql_query("SELECT * FROM poliklinik ORDER BY nama_poli ASC");
    $no=1;
  ...
  ?>
    <tr align='left'>
        ...
        <td width="10%">
<a class="btn btn-success Open-Edit" href='#' title='Edit Data' data-id="<?php echo $a[0]; ?>" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span></a>
<a href="#" onclick="confirm_modal('poliklinik-hapus.php?hapus=1&poliklinik=<?php echo $a[0]; ?>');"><button class="btn-danger btn"><span class="glyphicon glyphicon-trash"></span></button></a>
        </td>
    </tr>
    <?php
    $no++;
...
<div aria-hidden="true" aria-labelledby="myModalLabel1" role="dialog" tabindex="-1" id="ModalEdit" class="modal fade">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button aria-hidden="true" data-dismiss="modal" class="close" type="button">x</button>
                                              <h4 class="modal-title">Edit Data poliklinik</h4>
                                          </div>
                                          <div class="modal-body">
                                          </div>
                                      </div>
