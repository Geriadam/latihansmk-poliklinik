...
$res=mysql_query("SELECT * FROM pegawai WHERE id_pegawai=".$_SESSION['id']);
...
<form action="ganti-password-proses.php" method="post" role="form">
                <div class="form-group">
                	<div class="input-group">
                		<label>Password Lama</label>
  						<input name="pass_lama" type="text" class="form-control" id="nama" placeholder="Masukkan Password Lama" required="required"/>
              ...
              <input name="pass_ulang" type="text" class="form-control" id="nama" placeholder="Ulangi Password" required="required"/>
                ...
                <div class="form-group">
                	<input name="login" type="submit" class="btn btn-success" value="Ganti Pass" />
