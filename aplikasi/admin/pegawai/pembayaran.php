  ...
  ?>  
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Data Pembayaran</h3>
                </div>
            </div>
...
if(!empty($_GET['message']) && $_GET['message']=='success'){
    echo '<div class="alert alert-success alert-dismissible" role="alert">';
    echo '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
    echo '<h6><strong>Berhasil!</strong> Pembayaran Sukses</h6></div>';
}
?> 
                   <!-- Tabel Obat-->
...
ORDER BY pembayaran.tanggal desc";
  ...
  ?>
    <tr align='left'>
        ...
        <td width="15%">
        <div class="btn-group">
            <a class="Open-Edit btn btn-primary" href='#' title='Pembayaran' data-id="<?php echo $a[0]; ?>" data-toggle="modal">Proses</span></a>
            <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="" title="Periksa">
              <span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
                 <li>
                    <a href="cetak.php?pemeriksaan=<?php echo $a[2]; ?>">Cetak Kwintasi</a>
                </li>
                <li>
                    <a href="#" onclick="confirm_modal('pembayaran-hapus.php?hapus=1&pembayaran=<?php echo $a[0]; ?>&tindakan=<?php echo $a[2]; ?>');">Hapus</a>
                </li>
            </ul>
        </div><!-- /btn-group -->
        </td>
