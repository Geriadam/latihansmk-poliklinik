  ...
  ?>  
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Data Diagnosa</h3>
                </div>
            </div>
...
<tbody>
   <?php
    $s="SELECT A.nama_poli, B.nama_penyakit, B.id_penyakit FROM penyakit B, poliklinik A WHERE B.id_poli=A.id_poli ORDER BY A.nama_poli ASC";
    $query=mysql_query("$s");
    $no=1;
  ...
  ?>
    <tr align='left'>
        ...
        <td width="10%"><?php echo $a["nama_penyakit"]; ?></td>
        <td width="10%">
<a class="btn btn-success Open-Edit" href='#' title='Edit Data' id="<?php echo $a["id_penyakit"]; ?>" data-toggle="modal"><span class="glyphicon glyphicon-pencil"></span></a>
<a href="#" onclick="confirm_modal('penyakit-hapus.php?hapus=1&penyakit=<?php echo $a["id_penyakit"]; ?>');"><button class="btn-danger btn"><span class="glyphicon glyphicon-trash"></span></button></a>
        </td>
    </tr>
    <?php
    $no++;
